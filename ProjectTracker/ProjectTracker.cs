...
namespace ProjectTracker
{
    class ProjectTracker
    {
        ...
        private static string ShowGoalsMenu(Project project)
        {
            ...
            output += "Enter the goal number, ADD to add a new goal, DELETE to delete the project, or BACK to go back to projects";
            Console.WriteLine(output);
        ...
        {
            //clea the console and prompt the user to enter the new goal's name
            Console.Clear();
            Console.WriteLine("Enter the new goal name");
            string input = Console.ReadLine();
        ...
        private static void EditGoal(Project project, Goal goal)
        {
            ...
            Console.Clear();
            Console.WriteLine("Enter the goal's new name");

            //Read the user's input and set the goal's new name
            string? input = Console.ReadLine();
            goal.SetName(input);
            project.SaveProject();
        }
